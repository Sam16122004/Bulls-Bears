...
(function (h) {
    var x,
      ...
      L = function (a, b, c, d, e) {
        ...
        return j(
          Math.round(
            C * a.x + 3 * e * f * f * b.x + 3 * e * e * f * c.x + i * d.x
          ),
          Math.round(
            C * a.y + 3 * e * f * f * b.y + 3 * e * e * f * c.y + i * d.y
          )
        );
      },
      j = function (a, b) {
      ...
      M = function (a, b, c, d, e) {
        ...
        if ("-webkit-" == y) {
          ...
          var h = Math.atan2(f, i),
            g = h - Math.PI / 2,
            g =
              Math.abs(a.width() * Math.sin(g)) +
              Math.abs(a.height() * Math.cos(g)),
            i = Math.sqrt(f * f + i * i),
          ...
          a.css({
            "background-image":
              y + "linear-gradient(" + -h + "rad," + C.join(",") + ")",
          });
        }
      },
      g = {
        ...
        _addPage: function (a) {
          ...
          if (c)
            if (g._necessPage.call(this, a)) {
              ...
              (!a || 1 == g._setPageLoc.call(this, a)) &&
                g._makeFlip.call(this, a);
        ...
        _turnPage: function (a) {
          ...
          if (
            ...
            (a = d.pages[b].data().f.opts),
              (d.tpage = c),
              a.next != c &&
                ((a.next = c), (d.pagePlace[c] = a.page), (a.force = !0)),
              "single" == d.display
        ...
        _setPageLoc: function (a) {
          var b = this.data(),
            c = this.turn("view");
          if (a == c[0] || a == c[1])
            return b.pageWrap[a].css({ "z-index": b.totalPages, display: "" }), 1;
          if (
            ...
            return (
              b.pageWrap[a].css({ "z-index": b.totalPages - 1, display: "" }), 2
            );
      ...
      i = {
        ...
        options: function (a) {
          var b = this.data().f;
          return a
            ? (i.setData.call(this, { opts: h.extend({}, b.opts || Q, a) }), this)
            : b.opts;
        },
        z: function (a) {
          var b = this.data().f;
        ...
        _addPageWrapper: function () {
          ...
          if (!a.wrapper) {
            ...
            a.parent = b;
            a.fparent = a.opts.turn
              ? a.opts.turn.data().fparent
              : h("#turn-fwrappers");
            a.fparent ||
              ...
              a.opts.turn
                ? (c
                    .css(
                      l(
                        -a.opts.turn.offset().top,
                        -a.opts.turn.offset().left,
                        "auto",
                        "visible"
                      ).css
                    )
            ...
            a.wrapper = h("<div/>", l(0, 0, this.css("z-index")))
              .appendTo(b)
              .prepend(this);
            a.fwrapper = h("<div/>", l(b.offset().top, b.offset().left))
              .hide()
              .appendTo(a.fparent);
            a.fpage = h("<div/>", { css: { cursor: "default" } }).appendTo(
              h("<div/>", l(0, 0, 0, "visible")).appendTo(a.fwrapper)
            );
            a.opts.frontGradient &&
              (a.ashadow = h("<div/>", l(0, 0, 1)).appendTo(a.fpage));
          ...
          var o = this.data().f,
            ...
            F = function () {
              ...
              var l = d - Math.atan2(z.y, z.x),
                l = Math.max(
                  0,
                  Math.sin(l) * Math.sqrt(Math.pow(z.x, 2) + Math.pow(z.y, 2))
                );
              k = j(l * Math.sin(d), l * Math.cos(d));
              if (
                d > E &&
                ((k.x += Math.abs(k.y * Math.tan(B))),
                (k.y = 0),
                Math.round(k.x * Math.tan(G - d)) < u)
              )
                return (
                  (a.y = Math.sqrt(Math.pow(u, 2) + 2 * z.x * m.x)),
                  D && (a.y = u - a.y),
                  F()
                );
              if (
              ...
              if (
                ...
                ((g = 100 < v ? (v - 100) / v : 0),
                (f = j(
                  100 * ((v * Math.sin(E - d)) / u),
                  100 * ((v * Math.cos(E - d)) / r)
                )),
                D && (f.y = 100 - f.y),
                A)
              )
            ...
            x = function (a, c, e, k) {
              ...
              o.fwrapper.transform(
                s(-a.x + n.x + v, -a.y + n.y + q, w) + t(-k),
                e
              );
              o.fpage
                .parent()
                .transform(t(k) + s(a.x + p.x - n.x, a.y + p.y - n.y, w), e);
              o.opts.frontGradient &&
                M(
                  o.ashadow,
                  j(A ? 100 : 0, D ? 100 : 0),
          ...
          if (c)
            if (a) {
              if (!b.fpage.children()[b.ashadow ? "1" : "0"])
                i.setData.call(this, { backParent: c.parent() }),
                  b.fpage.prepend(c);
